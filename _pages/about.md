...
title: About
permalink: /
subtitle: Computer Science & Mathematics Student | UGA

profile:
  align: right
  image: profile.jpg                # Mets ta photo dans assets/img/profile.jpg
  image_circular: true              # Rend la photo circulaire
  more_info:                        # Laisse vide ou supprime si tu n'as pas d'adresse à afficher
    <p>Grenoble, France</p>
...
latest_posts:
  enabled: false                    # Désactivé (pas encore de blog)
  scrollable: true
  limit: 3
---
